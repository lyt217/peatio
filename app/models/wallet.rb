...
class Wallet < ApplicationRecord
  ...
  GATEWAYS = %w[axed australiacashd bitcoind bitcoincashd bitgo brigd bsha3d cubd cubisd dashd delord deimosd devaultd dogecoind geth genixd hengad lightningcash_goldd litecoind mazad mymnd myntd oasisd odind parity pigeond pownodesd ritod ravend qamblingchaind rippled sliced vetanid winod xandod xanod zenzod zeond zsub1xd].freeze
